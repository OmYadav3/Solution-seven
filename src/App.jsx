    ...
    <>
      ...
      <div className="main-box bg">
        ...
        <h1 className='bg '>{advice}</h1>
          <div className='line bg'><hr/></div>
        <div className='bg'>
          <img className='inner-img bg' src={DestopImg} alt="Not found"></img>
          </div>

      </div>
      <img className='outer-img ' onClick={getAdvice} src={IconDiceSvg} alt="Not found"></img>
